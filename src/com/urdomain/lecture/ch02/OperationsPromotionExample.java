...
class OperationsPromotionExample {
	...
	public static void main(String[] args) {
		...
		//연산 : +  * / % 형이틀린경우에는 큰 형으로 자동 형변환
		
		int a = 10;
		double b = 10.0;
	//	int c = (a+b);   // type mismatch : cannnot covert grom double to int
		int d = (int) (a+b);
		int e = a+ (int) b;
		double f = a+b;
		...
		//정수형연산 (byte,short,int) 은 int로 자동 형변환 , long은 제외 
	...
	//	byte byteValue3=byteValue1 + byteValue2 ; 컴파일에러
		...
		//char 은 int와 연산이 되면 int로 자동 형변환이 되어 연산 가능
		char charValue1 = 'A';
		char charValue2 = 1;
